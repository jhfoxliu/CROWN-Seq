...
if __name__ == "__main__":
    ...
    group_required.add_argument("--thresh-min", dest="thresh_min",required=False, type=int, default=-10,help="Distance limit, downstream")
    group_required.add_argument("--thresh-max", dest="thresh_max",required=False, type=int, default=10,help="Distance limit, upstream")
        ...
        while(line):
            ...
            if last_key is None:
                ...
                if key == last_key:
                    ...
                    if len(temp) == 1:
                        info = "{}|{}|{}".format(temp[0][5], temp[0][7], temp[0][8])
                        ...
                        info = "{}|{}|{}".format(best_one[5], best_one[7], best_one[8])
                        print("{}\t{}\t{}\t{}\t{}\t{}".format(last_key[0], last_key[1], last_key[2], info, last_key[3], last_key[4]), file=output)
